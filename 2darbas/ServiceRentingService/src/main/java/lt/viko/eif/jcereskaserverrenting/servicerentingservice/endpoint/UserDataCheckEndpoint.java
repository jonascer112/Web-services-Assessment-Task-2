package lt.viko.eif.jcereskaserverrenting.servicerentingservice.endpoint;

import lt.viko.eif.jcereskaserverrenting.servicerentingservice.models.GetUserDataCheckResponse;
import lt.viko.eif.jcereskaserverrenting.servicerentingservice.models.GetUserDataCheckRequest;
import lt.viko.eif.jcereskaserverrenting.servicerentingservice.services.UserDataCheckService;
...
public class UserDataCheckEndpoint {
    ...
    private static final String NAMESPACE = "http://www.ServerRenting.lt/viko/eif/jcereska/serverrenting/api/userDataCheck";
